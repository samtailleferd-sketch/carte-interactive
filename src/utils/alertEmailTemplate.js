          ...
          <table role="presentation" width="100%" style="max-width:480px;background:#17171c;border-radius:12px;overflow:hidden;">
            <tr>
              <td style="padding:24px 24px 0;">
                <span style="font-size:20px;font-weight:700;color:#4d9bff;">Street</span><span style="font-size:20px;font-weight:700;color:#e8e8ec;">Map</span>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding:20px 24px 0;" align="center">
                <a href="${salleUrl}" style="display:inline-block;background:#4d9bff;color:#08090c;text-decoration:none;font-weight:700;font-size:15px;padding:12px 28px;border-radius:999px;">Voir la salle</a>
              </td>
            </tr>
            <tr>
